...
// Originally made by SweetPagination, I edited it for my own purposed
// https://github.com/jahidulislamzim/sweetpagination

const Pagination= ({ dataPerPage, getData, currentPageData, navigation, getStyle, onPageChange, totalPages, filterButtonClicked, currentPageProp}) => {
  const pageNumbers = [];
